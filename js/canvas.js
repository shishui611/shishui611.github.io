...
Triangle.prototype.update = function() {
	// this.flame.segments[0].point.x = random(
	// 	this.flame.segments[1].point.x,
	// 	this.flame.segments[2].point.x
	// );

	// var dist = mousePos.subtract(paper.view.center).length;
	// var angle = mousePos.subtract(paper.view.center).angle;
	// var spread = map(dist, 0, 500, 10, 30);

	// this.flame.segments[0].point = paper.view.center.subtract(new Point({
	// 	length: map(dist, 0, 500, 2 * this.flameSize / 3, this.flameSize),
